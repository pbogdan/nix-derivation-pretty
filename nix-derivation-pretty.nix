{ mkDerivation, aeson, aeson-pretty, attoparsec, base, containers
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    aeson aeson-pretty attoparsec base containers nix-derivation
    optparse-applicative pretty-show prettyprinter
    prettyprinter-ansi-terminal protolude system-filepath text vector
  ];
